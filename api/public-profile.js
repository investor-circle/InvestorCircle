/**
 * api/public-profile.js — Vercel serverless function (Node)
 *
 * Phase 3 of the server-side DB access migration. Replaces the direct-Neon
 * getPublicProfile() query previously run from src/db.js. Deliberately
...
import { sql, setCors } from './_lib/auth.js';
